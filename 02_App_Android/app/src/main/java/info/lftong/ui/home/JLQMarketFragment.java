...
import info.lftong.adapter.HomesAdapter;
...
public class JLQMarketFragment extends MarketBaseFragment implements ICommonView {
   ...
   // private HomeTwoAdapter adapter;
    ...
    public static JLQMarketFragment getInstance(int type) {
        JLQMarketFragment jlqMarketFragment = new JLQMarketFragment();
    ...
    private void initRvContent() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ((MarketOperateCallback) getActivity()).itemClick(JLQMarketFragment.this.mAdapter.getItem(position), type);
            }
        });
